...
@:native("AWS.Detective") extern class Detective extends Service {
	/**
		Constructs a service object. This object has one method for each API operation.
	**/
	function new(?options:global.aws.detective.ClientConfiguration);
	/**
	...
	**/
	...
	function acceptInvitation(params:global.aws.detective.AcceptInvitationRequest, ?callback:(err:AWSError, data:{ }) -> Void):Request<{ }, AWSError>;
	/**
	...
	**/
	function createGraph(?callback:(err:AWSError, data:global.aws.detective.CreateGraphResponse) -> Void):Request<global.aws.detective.CreateGraphResponse, AWSError>;
	/**
		...
		Sends a request to invite the specified AWS accounts to be member accounts in the behavior graph. This operation can only be called by the master account for a behavior graph.   CreateMembers verifies the accounts and then sends invitations to the verified accounts. The request provides the behavior graph ARN and the list of accounts to invite. The response separates the requested accounts into two lists:   The accounts that CreateMembers was able to start the verification for. This list includes member accounts that are being verified, that have passed verification and are being sent an invitation, and that have failed verification.   The accounts that CreateMembers was unable to process. This list includes accounts that were already invited to be member accounts in the behavior graph.
	**/
	@:overload(function(?callback:(err:AWSError, data:global.aws.detective.CreateMembersResponse) -> Void):Request<global.aws.detective.CreateMembersResponse, AWSError> { })
	function createMembers(params:global.aws.detective.CreateMembersRequest, ?callback:(err:AWSError, data:global.aws.detective.CreateMembersResponse) -> Void):Request<global.aws.detective.CreateMembersResponse, AWSError>;
	/**
	...
	**/
	@:overload(function(?callback:(err:AWSError, data:{ }) -> Void):Request<{ }, AWSError> { })
	function deleteGraph(params:global.aws.detective.DeleteGraphRequest, ?callback:(err:AWSError, data:{ }) -> Void):Request<{ }, AWSError>;
	/**
		...
		Deletes one or more member accounts from the master account behavior graph. This operation can only be called by a Detective master account. That account cannot use DeleteMembers to delete their own account from the behavior graph. To disable a behavior graph, the master account uses the DeleteGraph API method.
	**/
	@:overload(function(?callback:(err:AWSError, data:global.aws.detective.DeleteMembersResponse) -> Void):Request<global.aws.detective.DeleteMembersResponse, AWSError> { })
	function deleteMembers(params:global.aws.detective.DeleteMembersRequest, ?callback:(err:AWSError, data:global.aws.detective.DeleteMembersResponse) -> Void):Request<global.aws.detective.DeleteMembersResponse, AWSError>;
	/**
	...
	**/
	@:overload(function(?callback:(err:AWSError, data:{ }) -> Void):Request<{ }, AWSError> { })
	function disassociateMembership(params:global.aws.detective.DisassociateMembershipRequest, ?callback:(err:AWSError, data:{ }) -> Void):Request<{ }, AWSError>;
	/**
		Returns the membership details for specified member accounts for a behavior graph.
		
		Returns the membership details for specified member accounts for a behavior graph.
	**/
	@:overload(function(?callback:(err:AWSError, data:global.aws.detective.GetMembersResponse) -> Void):Request<global.aws.detective.GetMembersResponse, AWSError> { })
	function getMembers(params:global.aws.detective.GetMembersRequest, ?callback:(err:AWSError, data:global.aws.detective.GetMembersResponse) -> Void):Request<global.aws.detective.GetMembersResponse, AWSError>;
	/**
		...
		Returns the list of behavior graphs that the calling account is a master of. This operation can only be called by a master account. Because an account can currently only be the master of one behavior graph within a Region, the results always contain a single graph.
	**/
	@:overload(function(?callback:(err:AWSError, data:global.aws.detective.ListGraphsResponse) -> Void):Request<global.aws.detective.ListGraphsResponse, AWSError> { })
	function listGraphs(params:global.aws.detective.ListGraphsRequest, ?callback:(err:AWSError, data:global.aws.detective.ListGraphsResponse) -> Void):Request<global.aws.detective.ListGraphsResponse, AWSError>;
	/**
		...
		Retrieves the list of open and accepted behavior graph invitations for the member account. This operation can only be called by a member account. Open invitations are invitations that the member account has not responded to. The results do not include behavior graphs for which the member account declined the invitation. The results also do not include behavior graphs that the member account resigned from or was removed from.
	**/
	@:overload(function(?callback:(err:AWSError, data:global.aws.detective.ListInvitationsResponse) -> Void):Request<global.aws.detective.ListInvitationsResponse, AWSError> { })
	function listInvitations(params:global.aws.detective.ListInvitationsRequest, ?callback:(err:AWSError, data:global.aws.detective.ListInvitationsResponse) -> Void):Request<global.aws.detective.ListInvitationsResponse, AWSError>;
	/**
		Retrieves the list of member accounts for a behavior graph. Does not return member accounts that were removed from the behavior graph.
		
		Retrieves the list of member accounts for a behavior graph. Does not return member accounts that were removed from the behavior graph.
	**/
	@:overload(function(?callback:(err:AWSError, data:global.aws.detective.ListMembersResponse) -> Void):Request<global.aws.detective.ListMembersResponse, AWSError> { })
	function listMembers(params:global.aws.detective.ListMembersRequest, ?callback:(err:AWSError, data:global.aws.detective.ListMembersResponse) -> Void):Request<global.aws.detective.ListMembersResponse, AWSError>;
	/**
	...
	**/
	@:overload(function(?callback:(err:AWSError, data:{ }) -> Void):Request<{ }, AWSError> { })
	function rejectInvitation(params:global.aws.detective.RejectInvitationRequest, ?callback:(err:AWSError, data:{ }) -> Void):Request<{ }, AWSError>;
	/**
	...
	**/
	@:overload(function(?callback:(err:AWSError, data:{ }) -> Void):Request<{ }, AWSError> { })
	function startMonitoringMember(params:global.aws.detective.StartMonitoringMemberRequest, ?callback:(err:AWSError, data:{ }) -> Void):Request<{ }, AWSError>;
