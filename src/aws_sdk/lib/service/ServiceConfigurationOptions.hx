...
typedef ServiceConfigurationOptions = {
	/**
	...
	**/
	@:optional
	var logger : aws_sdk.lib.config.Logger;
	/**
	...
	**/
	@:optional
	var paramValidation : ts.AnyOf2<Bool, aws_sdk.lib.config.ParamValidation>;
	/**
	...
	**/
	@:optional
	var retryDelayOptions : aws_sdk.lib.config.RetryDelayOptions;
	/**
